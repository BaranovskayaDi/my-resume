...
const userName = document.querySelector('#callbak-form-input-name');
const userEmail = document.querySelector('#callbak-form-input-email');
const userPhone = document.querySelector('#callbak-form-input-phone');
...
callbackForm.addEventListener('submit',function(event){
    ...
    if (!userName.value.trim()) {
        userName.classList.add('callbak-form-input-error');
        hasError = true;
    } else {
        userName.classList.remove('callbak-form-input-error');
    }
    
    if (!userEmail.value.trim() || !isEmailValid(userEmail.value)) {
        userEmail.classList.add('callbak-form-input-error');
        hasError = true;
    } else {
        userEmail.classList.remove('callbak-form-input-error');
    }
    
    if (!userPhone.value.trim() || !isPhoneValid(userPhone.value)) {
        userPhone.classList.add('callbak-form-input-error');
        hasError = true;
    } else {
        userPhone.classList.remove('callbak-form-input-error');
    }
